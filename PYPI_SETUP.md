...
1. **Go to:** https://github.com/FlossWare/semantic-search-ai/settings/secrets/actions
...
Visit: https://pypi.org/project/semantic-search-ai/
...
- `flossware-semantic-search-ai`
- `semantic-search-ai-flossware`

Update `setup.py`:
```python
setup(
    name="flossware-semantic-search-ai",  # Changed
    ...
)
```
...
4. Create new token scoped to **specific project**
   - Name: `semantic-search-ai-only`
   - Scope: `Project: semantic-search-ai`
...
**Download stats:**
- https://pypistats.org/packages/semantic-search-ai
