...
Semantic Search AI is available as native packages for multiple operating systems.
...
# Or via pkg (when available)
pkg_add py39-semantic-search-ai
```
...
| System | Package Name |
|--------|-------------|
| **RHEL/CentOS/Fedora** | `python3-semantic-search-ai` |
| **Debian/Ubuntu** | `python3-semantic-search-ai` |
| **FreeBSD** | `py39-semantic-search-ai` |
| **OpenBSD** | `py3-semantic-search-ai` |
| **NetBSD** | `py39-semantic-search-ai` |
| **Python/pip** | `semantic-search-ai` |
...
```bash
python3 -c "from vectordb_ai import VectorStoreFactory; print('✅ Semantic Search AI installed')"
```
