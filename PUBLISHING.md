# Publishing Semantic Search AI

This document explains how Semantic Search AI packages are published to multiple repositories.
...
```bash
# One-time setup
pip install --index-url https://packagecloud.io/FlossWare/releases/pypi/simple semantic-search-ai
...
**Install:**
```bash
pip install semantic-search-ai --extra-index-url https://ghcr.io/FlossWare/semantic-search-ai
```
...
├── PyPI:            https://pypi.org/project/semantic-search-ai/
├── packagecloud:    https://packagecloud.io/FlossWare/releases/packages/python/semantic-search-ai
└── GitHub:          https://github.com/FlossWare/semantic-search-ai/packages
```
...
```bash
pip install git+https://github.com/FlossWare/semantic-search-ai.git
```

### Method 4: Local Development
```bash
git clone https://github.com/FlossWare/semantic-search-ai.git
cd semantic-search-ai/python
pip install -e .
```
...
View releases:
- GitHub: https://github.com/FlossWare/semantic-search-ai/releases
- PyPI: https://pypi.org/project/semantic-search-ai/#history
