...
```
/usr/ports/devel/py-semantic-search-ai/
...
WWW=            https://github.com/FlossWare/semantic-search-ai
...
```bash
# From ports
cd /usr/ports/devel/py-semantic-search-ai
make install clean

# From packages (pre-built)
pkg install py39-semantic-search-ai
```
...
```makefile
COMMENT=        advanced semantic search toolkit for AI applications

MODPY_EGG_VERSION=      0.2
DISTNAME=       semantic-search-ai-${MODPY_EGG_VERSION}
PKGNAME=        py-${DISTNAME}

CATEGORIES=     devel

HOMEPAGE=       https://github.com/FlossWare/semantic-search-ai
...
# From packages
pkg_add py3-semantic-search-ai
```
...
```
/usr/pkgsrc/devel/py-semantic-search-ai/
├── Makefile              # Port configuration
├── distinfo              # Checksums
├── DESCR                 # Description
└── PLIST                 # File list
...
```makefile
DISTNAME=       semantic-search-ai-0.2
...
```bash
# From pkgsrc
cd /usr/pkgsrc/devel/py-semantic-search-ai
make install

# From binary packages
pkgin install py39-semantic-search-ai
```
...
### FreeBSD
1. Create port in `/usr/ports/devel/py-semantic-search-ai/`
...
### NetBSD (pkgsrc)
1. Create package in `/usr/pkgsrc/devel/py-semantic-search-ai/`
2. Test with `pkglint`
...
|-----|-------------|------------------------|
| **FreeBSD** | `py39-semantic-search-ai` | `pkg` |
| **OpenBSD** | `py3-semantic-search-ai` | `pkg_add` |
| **NetBSD** | `py39-semantic-search-ai` | `pkgin` |
| **DragonFly** | `py39-semantic-search-ai` | `pkg` |
